...
@app.route('/CC/teacher_book')
def teacher_book():
    return render_template('teacher_book.html')

@app.route('/CC/student_book')
def student_book():
...
# Student Dashboard
@app.route('/CC/teacher_book/student_dashboard')
...
@app.route('/CC/student_book/student_dashboard/class_room_student')
def class_room_student():
    return render_template('class_room_student.html')

#techer dasboard
@app.route('/CC/teacher_book/teacher_dashboard')
...
@app.route('/CC/teacher_book/teacher_dashboard/classroom_view')
def classroom_view():
